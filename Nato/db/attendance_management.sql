...
CREATE DATABASE `attendance_management` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
CREATE USER 'nato'@'%' IDENTIFIED BY '';

GRANT ALL PRIVILEGES ON `attendance_management`.* TO 'nato'@'%';
